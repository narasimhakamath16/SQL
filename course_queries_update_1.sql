...
--1. Write a query to show the oldest and the newest employee by first name, department, hire date and country
--Only 2 employees should be displayed.
...
--2. Write a query to compute the sum of salaries for every 90 days starting from first employee to last employee by hire date
--Not convinced by the query to this question - how can it be hire_date - 90
